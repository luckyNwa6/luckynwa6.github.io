...
if (document.getElementById('history-container')) {
  ...
  var history_get_data = function history_get_data() {
    ...
    console.log('https://cdn1.tianli0.top/gh/Zfour/Butterfly-card-history@latest/baiduhistory/json/' + getMonth + '.json', getMonthDate)
  ...
  fetch(history_data[0])
    ...
    .then(function (data) {
      ...
      try {
        for (
          var _iterator = data[history_data[1]][Symbol.iterator](), _step;
